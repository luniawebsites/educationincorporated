		...
		<section class="pad-respond-xy-mob theme-white border-b-mob shadow-t-mob">
			...
			<div class="flow-ttb-mob flow-ltr-tab constrain spread-respond pad-y-mob align-fs-tab">
				...
				<article class="width-100-mob width-70-tab">
					...
					<p>Education Incorporated is a registered IEB school and writes the IEB examinations. The IEB is not a curriculum, it is an examination board. Visit their website <a href="http://www.ieb.co.za/School/iebnsc.php" target="_blank" rel="noopener">for more detailed information</a>.</p>
