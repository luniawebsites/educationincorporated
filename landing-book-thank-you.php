...
<body class="theme-dark-grey">
	...
	<main>
		...
		<section class="pad-respond-xy-mob theme-white border-b-mob shadow-t-mob">
			...
			<h1 class="pad-respond-t-mob text-underline-red">Thank You!</h1>
			...
			<div class="flow-ttb-mob flow-ltr-tab constrain pad-respond-y-mob align-fs-tab">
				...
				Main content
				-->
				<p>Thank you for requesting a copy of our book "Educating Your 22nd Century Child". Please check your inbox for our mail to confirm your address (anti-spam measure, sorry for the hassle). Once you've confirmed your email address we'll send you the download link. We look forward to hearing from you with any questions. Enjoy your reading.</p>
