...
<head>
	...
	<meta name="pagename" content="Education Incorporated Boutique School Sports Achievers">
	...
	<meta property="og:title" content="Education Incorporated Boutique School Sports Achievers" />
	<meta property="og:keywords" content="" />
	<meta property="og:description" content="" />
	<meta property="og:locale" content="en_ZA" />
	<meta property="og:url" content="https://educationincorporated.co.za/sports-achievers.php" />
	<meta property="og:image" content="https://educationincorporated.co.za/assets/images/education-incorporated-logo.png" />
	<meta property="og:type" content="website" />
	<link rel="canonical" href="https://educationincorporated.co.za/sports-achievers.php" />
	<title>Education Incorporated Boutique School Sports Achievers</title>
...
<body class="theme-dark-grey">
	...
	<main>
		...
		<header class="flow-ttb-mob constrain pad-x-mob pad-double-y-mob">
			...
			<h1 class="text-underline-red">Our Students Are Sports Achievers</h1>
			<div class="margin-y-mob pad-b-mob quote-white"></div>
			<div class="h3">EduInc is home to sports achievers who complete at both Provincial and National level.</div>
		...
		<section class="pad-respond-xy-mob theme-white border-b-mob shadow-t-mob">
			...
			<div class="flow-ttb-mob flow-ltr-tab constrain spread-respond pad-y-mob align-fs-tab">
				...
				<article class="width-100-mob width-70-tab">
					...
					<picture class="article__author-image radius-mob border-b-mob" style="margin-bottom:3rem">
						<source srcset="assets/images/photos/author__kaleigh-telfer.webp" type="image/webp" />
						<img src="assets/images/photos/author__kaleigh-telfer.jpg" alt="gershom aitchison photo" />
					</picture>

					<p>Young Springboks and provincial sportspeople have gruelling training and competition programmes that often become difficult to sustain while simultaneously managing the rigours of a full academic schedule. We understand these pressures and support our young sportspeople by offering a degree of flexibility.</p>

					<p>Our dedicated staff support our sports stars and are always willing to assist them in reaching their goals&mdash;both on the playing fields and in the classroom&mdash;achieving the best possible results in both arenas.</p>

					<em class="radius-mob theme-grey accent-blue">We assist in managing students' academic schedules while encouraging their best sports performances.</em>
