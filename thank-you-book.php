...
<body class="theme-dark-grey">
	...
	<main>
		...
		<section class="pad-respond-xy-mob theme-white border-b-mob shadow-t-mob">
			...
			<h1 class="pad-respond-t-mob text-underline-red">Your book is on its way.</h1>
			...
			<div class="flow-ttb-mob flow-ltr-tab constrain pad-respond-y-mob align-fs-tab">
				...
				Main content
				-->
				<p>Well done! This book will help you ask the right questions of any school you're considering. As an anti-spam measure, a confirmation mail is on its way to you. Please click the link in that mail and you'll imemdiately receive the download link for our book. While you wait, perhaps take a few more minutes to explore our site and see what a school with such small classes can do for your child. You can also download our prospectus. Thank you for your interest in our school.</p>
