...
<body class="theme-dark-grey">
	...
	<main>
		...
		<section class="pad-respond-xy-mob theme-white border-b-mob shadow-t-mob">
			...
			<h1 class="pad-respond-t-mob text-underline-red">Thank you — We have received your request for additional information</h1>
			...
			<div class="flow-ttb-mob flow-ltr-tab constrain pad-respond-y-mob align-fs-tab">
				...
				Main content
				-->
				<p>A mail is on its way to you now, thank you for your interest in our school.</p>
