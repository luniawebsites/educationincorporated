...
<body class="theme-dark-grey">
	...
	<main>
		...
		<section class="pad-respond-xy-mob theme-white border-b-mob shadow-t-mob">
			...
			<h1 class="pad-respond-t-mob text-underline-red">Trial Week Accepted, thank you.</h1>
			...
			<div class="flow-ttb-mob flow-ltr-tab constrain pad-respond-y-mob align-fs-tab">
				...
				Main content
				-->
				<p>Congratulations on acepting our offer of a trial Week and proposing a starting date. We'll be in touch shortly to confirm the details and send you all the information your require to make this a successful time.</p>
